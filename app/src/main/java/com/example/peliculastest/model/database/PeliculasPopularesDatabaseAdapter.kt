...
class PeliculasPopularesDatabaseAdapter {
    ...
    private val TABLA_PELICULAS = "tabla_peliculas_populares"
    ...
    companion object {
        private var peliculasAdapterInstance: PeliculasPopularesDatabaseAdapter? = null

        fun obtenerPeliculasDBAdapterInstance(context: Context?): PeliculasPopularesDatabaseAdapter? {
            if (peliculasAdapterInstance == null) {
                peliculasAdapterInstance = PeliculasPopularesDatabaseAdapter(context)
            }
